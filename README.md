...
This repository contains the implementation of an Improved Voxel Autoencoder (IVA-128) capable of reconstructing 3D voxel grids from single-view 2D images.
The project integrates Attention Mechanisms, Deep CNN Encoding, 3D Transposed Convolution Decoding, and Explainable AI (Guided Saliency) to provide both high-quality voxel reconstruction and transparent model reasoning.
...
Trained on Pix3D Chairs subset, real-image dataset with aligned 3D shapes.
...
Train / test the model following the notebook instructions.
